function sched=airdropx_phys_mpc_build_recovery_bank_v134(sched,opts)
%AIRDROPX_PHYS_MPC_BUILD_RECOVERY_BANK_V134 Event-gated transient gust-recovery cost bank.
%
...
arguments
    ...
    opts.MaxQMultiplier (:,1) double {mustBeFinite,mustBePositive} = [0.85;4.0;0.90;0.90;1.20;1.0;1.0]
    opts.MaxRMultiplier (:,1) double {mustBeFinite,mustBePositive} = [0.55;0.85]
end
...
sched.recovery=struct("version","AirdropX v1.3.4 event-gated recovery bank","levels",levels, ...
