function R=airdropx_phys_mpc_base_equivalence_audit_v135(projectRoot,opts)
%AIRDROPX_PHYS_MPC_BASE_EQUIVALENCE_AUDIT_V135 Same-seed calm A/B between v1.3.5 wind path and certified legacy base solver.
arguments
...
if opts.OutputRoot=="", opts.OutputRoot=fullfile(projectRoot,"matlab","results","physics_mpc_v135_base_equivalence_audit"); end
...
R=struct(); R.version="Physics-MPC v1.3.5 base-equivalence audit"; R.sensor_noise_seed=opts.SensorNoiseSeed; R.wind_report_pass=rw.pass; R.legacy_report_pass=rl.pass;
...
fprintf(fid,"Physics-MPC v1.3.5 base-equivalence audit\n");
