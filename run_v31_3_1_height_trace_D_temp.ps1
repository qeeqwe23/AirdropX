...
$runId = "v31_3_1_href_trace_" + (Get-Date -Format "yyyyMMdd_HHmmss") + "_" + ([guid]::NewGuid().ToString("N").Substring(0,6))
...
Write-Host "AirdropX v31.3.1 isolated height-reference trace (cfg0, V=50, no training, no drops, no scheduler)"
...
P=[0 200 50; 30 195 50; 90 200 50; 150 205 50; 210 200 50];
r=airdropx_v31_3_dynamic_reference_validation('ProjectRoot',pwd, ...
 ...
 'OutputRoot','matlab/results/mpc_auto_v31/dynamic_reference_validation/cfg0_height_trace_v31_3_1', ...
 'ReferenceProfile',P,'FixedConfigId',0,'EnableDrops',false,'UseScheduler',false, ...
 'ReferenceInstrumentationEnabled',true,'StopTimeS',250,'PostProfileSettleS',30);
disp(r);
"@
