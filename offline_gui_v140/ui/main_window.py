...
class MainWindow(QMainWindow):
    def __init__(self, app_root: Path):
        ...
        self.setWindowTitle("AirdropX MQ-9 Reaper Cargo 空投仿真与测控平台 v2.2 · Physics-MPC v1.4.0")
        ...
        outer.setSpacing(3)
        top = QHBoxLayout()
        title = QLabel("AirdropX MQ-9 Reaper Cargo 空投仿真与测控平台 v2.2")
        title.setObjectName("Title")
        self.state = QLabel("任务状态: 待机  后端: Physics-MPC v1.4.0")
        ...
        self.statusBar().showMessage(f"Python {platform.python_version()} | PyQt6 | 离线模式 | v1.4.0 sensor-realistic")
    ...
    def start(self, cfg):
        ...
        self.state.setText("任务状态: 运行中")
        self.progress.setValue(1)
        self.analysis.append_log("[GUI] 启动 v1.4.0 后端...")
    ...
    def reset(self):
        ...
        self.analysis.reset()
        self.progress.setValue(0)
        self.state.setText("任务状态: 待机  后端: Physics-MPC v1.4.0")
