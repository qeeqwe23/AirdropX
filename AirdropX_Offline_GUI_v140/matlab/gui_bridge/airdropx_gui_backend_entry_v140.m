...
%AIRDROPX_GUI_BACKEND_ENTRY_V140 JSON bridge for the reconstructed PyQt6 GUI.
arguments
...
fprintf("[GUI] Physics-MPC v1.4.0 backend start\n");
...
% GUI runs are engineering exploration unless the exact published formal scenario
% and certified point are selected. Formal v1.4.0 source paths themselves remain unchanged.
...
fprintf("[GUI] mission complete pass=%d\n",logical(report.pass));
end
