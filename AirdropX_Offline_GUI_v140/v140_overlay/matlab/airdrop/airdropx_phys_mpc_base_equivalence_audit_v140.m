function R=airdropx_phys_mpc_base_equivalence_audit_v140(projectRoot,opts)
%AIRDROPX_PHYS_MPC_BASE_EQUIVALENCE_AUDIT_V140 Same-seed sensor-realistic calm A/B.
arguments
...
if opts.OutputRoot=="", opts.OutputRoot=fullfile(projectRoot,"matlab","results","physics_mpc_v140_sensor_base_equivalence_audit"); end
...
rw=airdropx_wind_airdrop_mission_v140(projectRoot,OutputRoot=wmDir,ScenarioName="calm",UseWindCompensation=true,UseWindDisturbanceMPC=true,UseFractionalRelease=true,UseWindConfidenceGate=true,UseUnifiedGustRecovery=true,UseRealisticAvionics=true,UseIndependentCargoTruth=true,WindCalibrationPath=opts.WindCalibrationPath,Duration_s=opts.Duration_s,SensorNoiseSeed=opts.SensorNoiseSeed,ThrowOnFail=false);
rl=airdropx_wind_airdrop_mission_v140(projectRoot,OutputRoot=legacyDir,ScenarioName="calm",UseWindCompensation=true,UseWindDisturbanceMPC=false,UseFractionalRelease=true,UseWindConfidenceGate=true,UseUnifiedGustRecovery=false,UseRealisticAvionics=true,UseIndependentCargoTruth=true,WindCalibrationPath=opts.WindCalibrationPath,Duration_s=opts.Duration_s,SensorNoiseSeed=opts.SensorNoiseSeed,ThrowOnFail=false);
...
R=struct(); R.version="Physics-MPC v1.4.0 sensor-realistic base-equivalence audit"; R.sensor_noise_seed=opts.SensorNoiseSeed; R.wind_report_pass=rw.pass; R.legacy_report_pass=rl.pass;
...
fprintf(fid,"Physics-MPC v1.4.0 sensor-realistic base-equivalence audit\n");
