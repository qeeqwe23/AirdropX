function out=airdropx_cargo_truth_plant_v136p(scenarioName,release,opts)
%AIRDROPX_CARGO_TRUTH_PLANT_V136P Independent scoring-only cargo plant.
...
arguments
    ...
    release (1,1) struct
    opts.Params (1,1) struct = airdropx_cargo_truth_params_v136p()
...
for k=1:ceil(p.max_fall_time_s/dt)
    ...
    if h2<=0
        ...
        out=struct("impact_x_m",impact,"fall_time_s",fall,"range_m",impact-x0,"steps",k,"mode","independent_2d_drag_truth_v136p","CdA_m2",CdA); return
    end
