...
$backup=Join-Path $ProjectRoot ("matlab\phys_mpc_controller_pre_v052_"+$stamp)
...
Write-Host "Installed Physics-MPC v0.5.2 drop-timing comparison overlay into $ProjectRoot"
