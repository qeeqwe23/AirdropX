...
cfg.safety_feedback.h_gain_throttle = -0.025;
cfg.safety_feedback.vz_gain_throttle = -0.010;
cfg.safety_feedback.limit = [0.90; 0.08];
...
opts.InnerPitchKp = 0.25;
opts.InnerPitchKd = 0.060;
opts.InnerElevatorLimit = 0.85;
opts.InnerElevatorRateLimit = 0.06;
opts.InnerMassGainElevator = -2.0e-5;
opts.InnerCgGainElevator = 0.03;
opts.InnerTrimElevator = 0.0;
opts.PitchRefMinDeg = -2.0;
opts.PitchRefMaxDeg = 9.0;
opts.UseDirectMpcAllocation = false;
