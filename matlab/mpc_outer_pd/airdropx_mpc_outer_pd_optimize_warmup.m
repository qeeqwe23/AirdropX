...
dropPenalty = abs(double(opts.CarpDropTotal) - double(metrics.drop_events));
missPenalty = max(0.0, metrics.impact_miss_mean_m - opts.MaxUsefulImpactMissM);
...
row = table( ...
    ...
    metrics.drop_events, metrics.impact_miss_mean_m, ...
    ...
    'VariableNames', { ...
        ...
        'drop_events', 'impact_miss_mean_m', ...
