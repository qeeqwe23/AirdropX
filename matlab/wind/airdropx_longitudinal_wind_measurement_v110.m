function m=airdropx_longitudinal_wind_measurement_v110(Va_mps,Vz_mps,Vg_mps,opts)
%AIRDROPX_LONGITUDINAL_WIND_MEASUREMENT_V110 Geometry-only longitudinal wind observation.
