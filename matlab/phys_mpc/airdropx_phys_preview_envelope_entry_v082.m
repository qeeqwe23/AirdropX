function report=airdropx_phys_preview_envelope_entry_v082(projectRoot,opts)
%AIRDROPX_PHYS_PREVIEW_ENVELOPE_ENTRY_V082 Diagnostic mission that may use explicitly uncertified-but-usable vertices.
arguments
...
try
    ...
    if ~all(usable)
        ...
        name=string(sprintf("H%03d_V%03d_preview_only_diag_v082",round(opts.Height_m),round(opts.Speed_mps)));
