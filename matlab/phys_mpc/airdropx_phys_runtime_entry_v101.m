function report=airdropx_phys_runtime_entry_v101(projectRoot,opts)
%AIRDROPX_PHYS_RUNTIME_ENTRY_V101 Isolated-process wrapper with durable completion marker.
arguments
...
try
    report=airdropx_phys_runtime_command_closed_loop_v101(projectRoot,MasterBankPath=opts.MasterBankPath,OutputRoot=opts.OutputRoot,ScenarioName=opts.ScenarioName,Duration_s=opts.Duration_s,CommandPreviewMode=opts.CommandPreviewMode,ThrowOnFail=false);
