function sched=airdropx_phys_mpc_build_recovery_bank_v133(sched,opts)
%AIRDROPX_PHYS_MPC_BUILD_RECOVERY_BANK_V133 Event-gated transient gust-recovery cost bank.
%
...
arguments
    ...
    opts.MaxQMultiplier (:,1) double {mustBeFinite,mustBePositive} = [1.35;3.5;1.35;1.8;2.6;1.0;1.0]
    opts.MaxRMultiplier (:,1) double {mustBeFinite,mustBePositive} = [0.85;0.55]
end
...
sched.recovery=struct("version","AirdropX v1.3.3 event-gated recovery bank","levels",levels, ...
