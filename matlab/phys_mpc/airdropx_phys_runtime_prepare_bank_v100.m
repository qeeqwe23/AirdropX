function bank=airdropx_phys_runtime_prepare_bank_v100(masterBankPath)
%AIRDROPX_PHYS_RUNTIME_PREPARE_BANK_V100 Prepare fast indexed access to the 475 usable anchors.
arguments
...
bank=struct("version","Physics-MPC v1.0.0 runtime indexed bank","source",masterBankPath,"vertices",{S.vertices},"rows",r,"hGrid",hGrid,"vGrid",vGrid,"index",idx, ...
