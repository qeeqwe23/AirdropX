function s=airdropx_longitudinal_wind_estimator_init_v110(Ts,opts)
%AIRDROPX_LONGITUDINAL_WIND_ESTIMATOR_INIT_V110 Two-state adaptive Kalman wind observer.
arguments
...
s=struct();
s.version="AirdropX longitudinal wind estimator v1.1.0";
s.Ts=Ts;
