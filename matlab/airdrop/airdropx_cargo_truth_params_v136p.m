function p=airdropx_cargo_truth_params_v136p()
%AIRDROPX_CARGO_TRUTH_PARAMS_V136P Independent 2-D cargo plant parameters.
...
p=struct();
p.version="AirdropX independent cargo truth plant v1.3.6-Paper";
