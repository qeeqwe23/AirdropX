...
public:
    ...
    mxArray* info() const
    {
        ...
        mxSetField(s,0,"version",mxCreateString("AirdropX JSBSim physics oracle v0.3.1"));
        return s;
    }
...
private:
    ...
    mxArray* diagnostics() const
    {
        ...
        mxArray* s=mxCreateStructMatrix(1,1,20,f);
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    try {
        ...
        if (cmd == "version") {
            if (nlhs>0) plhs[0]=mxCreateString("AirdropX JSBSim physics oracle v0.3.1");
            return;
        }
