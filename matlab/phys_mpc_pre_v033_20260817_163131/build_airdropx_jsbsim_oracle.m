...
%BUILD_AIRDROPX_JSBSIM_ORACLE Transactional build of Physics Oracle v0.3.3.
...
try
    ...
    assert(contains(string(v),"v0.3.3"),"Candidate Oracle returned unexpected version: %s",string(v));
catch ME
    clear airdropx_jsbsim_oracle_mex;
...
try
    ...
    assert(contains(string(vInstalled),"v0.3.3"), ...
